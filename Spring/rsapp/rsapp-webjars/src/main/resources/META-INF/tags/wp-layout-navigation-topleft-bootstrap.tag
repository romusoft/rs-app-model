...
<div class="wp-layout-main">
	...
	<div class="wp-main-header">
		<jsp:include
			page="/META-INF/resources/views/navigationSectionTopBootstrap.jsp" />
	</div>
	...
	<div class="wp-main-content">
		...
		<!-- side navigation -->
		<div
			class="wp-sidenavigation ${navigationPreference.cssToggleDisplay }">
			<jsp:include
				page="/META-INF/resources/views/navigationSectionLeft.jsp" />
		</div>
