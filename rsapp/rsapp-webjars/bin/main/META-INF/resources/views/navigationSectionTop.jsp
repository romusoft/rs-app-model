...
<div class="container-fluid tab-navigation  wp-main-header">
	...
	<div class="outer-tab" style="padding: 0px;">
				...
				<li id="${tab.name}" class="dropdown  ${ tab.cssActive} ">
					<div class="btn-group">
						<a class="btn btn-link" href="${tab.defaultUri}?tab=${tab.name}"
							title="${tab.description}"> ${tab.title} </a>
		...
		<ul id="help-menu" style="background-color: #f8f9f9;">
			<li>Help
				<ul>
					...
					<li><a href="#"
									onclick="window.open('pm-help', '_blank',
									'top=200,left=300,location=no,status=no,menubar=no,toolbar=no,scrollbars=yes,resizable=yes, width=640,height=auto')"> Help Content</a></li>
					<li>
